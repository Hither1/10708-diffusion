...
from nuplan.planning.training.modeling.models.diffusion_model import convert_predictions_to_trajectory
        ...
        for idx, (vector_map, agents, target_trajectory, predicted_trajectory) in enumerate(zip(
            ...
            if not visualize_diffusion:
                ...
                predicted_trajectories = [
                    Trajectory(data=convert_predictions_to_trajectory(predictions['multimodal_trajectories'][idx:idx+1,i])) \
