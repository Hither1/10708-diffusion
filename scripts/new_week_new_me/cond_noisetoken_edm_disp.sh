...
python nuplan/planning/script/run_training.py \
    ...
    job_name=cond_noisetoken_edm_disp \
    py_func=train \
    ...
    callbacks.model_checkpoint_callback.every_n_epochs=2 \
    optimizer=adamw \
    optimizer.lr=1e-4 \
    ...
    +lightning.trainer.params.resume_from_checkpoint="/home/scratch/brianyan/nuplan_exp/exp/diffusion-v3-mini/cond_noisetoken_edm_disp/2023.08.21.12.10.10/checkpoints/epoch\=200.ckpt"