...
python nuplan/planning/script/run_simulation.py \
    ...
    planner=ml_planner \
    planner.ml_planner.checkpoint_path="/zfsauton/datasets/ArgoRL/brianyan/nuplan_exp/diffusion-v3-mini/2023.08.20.16.00.25/checkpoints/epoch\=250.ckpt" \
    planner.ml_planner.replan_freq=5 \
    scenario_builder=nuplan \
    scenario_filter=reduced_val14_split \
    number_of_gpus_allocated_per_simulation=0.25 \
    experiment_name=diffusion_abs \
